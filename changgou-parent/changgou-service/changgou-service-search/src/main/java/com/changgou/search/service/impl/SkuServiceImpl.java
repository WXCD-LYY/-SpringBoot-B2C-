...
public class SkuServiceImpl implements SkuService {
    ...
    public Map<String, Object> search(Map<String, String> searchMap) throws Exception {
         ...
         * 搜索条件封装
         */
        NativeSearchQueryBuilder nativeSearchQueryBuilder = buildBasinQuery(searchMap);
     ...
     * @return
     */
    public NativeSearchQueryBuilder buildBasinQuery(Map<String, String> searchMap) {
...
//                boolQueryBuilder.must(QueryBuilders.termQuery("name", searchMap.get("keywords")));
            }
            ...
            // price 区间 例： 0-500 500-1000 ---- 3000元以上
                ...
                .queryForPage(
                        ...
                        new SearchResultMapper() {
                            ...
                            public <T> AggregatedPage<T> mapResults(SearchResponse response, Class<T> aClass, Pageable pageable) {
                                ...
                                for (SearchHit hit : response.getHits()) { // 执行查询后的所有数据
    ...
    public Map<String, Set<String>> putAllSpec(List<String> specList) {
        ...
        for (String spec : specList) {
            ...
            for (Map.Entry<String, String> entry : specMap.entrySet()) {
                // 4.1 取出当前Map，并且获取当前对应的Key，以及对应value
